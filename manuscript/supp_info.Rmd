...
```{r figure10, fig.cap="Distribution of choices for the second choice in the choice condition", fig.align="center", out.width="100%"}
knitr::include_graphics("../plots/supp/choicedist2.png")
```

```{r figure10, fig.cap="Distribution of choices for the third choice in the choice condition", fig.align="center", out.width="100%"}
knitr::include_graphics("../plots/supp/choicedist3.png")
```

```{r figure10, fig.cap="Distribution of choices for the fourth choice in the choice condition", fig.align="center", out.width="100%"}
